...
class Success extends StatelessWidget {
  ...
  const Success(
      {super.key, required this.SheduledDateTiime, required this.time_slot});
              ...
              GestureDetector(
                onTap: () {
                  ScaffoldMessenger.of(context).showSnackBar(
                      SnackBar(content: Text('Thanks for Purchasing!')));

                  Navigator.of(context).push(
                      MaterialPageRoute(builder: (context) => LabTests()));
                },
                child: Container(
